...
/**
 * 本探针基于YaHei.net探针
 * LTNMP一键安装包 BY:安迪后院 http://www.moqifei.com/ltnmp
 */
...
<head>
<title>PHP探针 for LTNMP一键安装包</title>
...
<div id="footer">
&copy; 2014 - <?php echo date('Y');?> <a href="http://www.moqifei.com/ltnmp" target="_blank">LTNMP一键安装包</a><br />This Prober was based on Yahei Prober.<br />
