...
clear
printf "=======================================================================\n"
printf "Install Memcached for LTNMP  ,  Written by php360 \n"
printf "=======================================================================\n"
printf "LTNMP is a tool to auto-compile & install Tengine+Nginx+MySQL+PHP on Linux \n"
printf "This script is a tool to install memcached for ltnmp \n"
printf "\n"
...
if [ -s memcache-3.0.8.tgz ]; then
	...
	echo "memcache-3.0.8.tgz not found!download it......"
	wget -c http://www.05gzs.com/ltnmp/memcache-3.0.8.tgz
fi
#wget -c http://ltanmp.googlecode.com/files/memcache-3.0.8.tgz
...
if [ -s libevent-2.0.21-stable.tar.gz ]; then
	...
	echo "libevent-2.0.21-stable.tar.gz not found!download it......"
	wget -c http://www.05gzs.com/ltnmp/libevent-2.0.21-stable.tar.gz
fi
#wget -c http://ltanmp.googlecode.com/files/libevent-2.0.21-stable.tar.gz
...
if [ -s memcached-1.4.15.tar.gz ]; then
	...
	echo "memcached-1.4.15.tar.gz not found!download it......"
	wget -c http://www.05gzs.com/ltnmp/memcached-1.4.15.tar.gz
fi
#wget -c http://ltanmp.googlecode.com/files/memcached-1.4.15.tar.gz
...
cp conf/memcached.php /home/www/default/memcached.php
